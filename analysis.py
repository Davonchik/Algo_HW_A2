...
def build_plot(title, x_m, y_m, x_m_i, y_m_i):
    ...
    plt.plot(x_m, y_m, label="Merge Sort")
    plt.plot(x_m_i, y_m_i, label="Merge Improved sort")
...
x1, y1 = read_series_from_file("m_s_test1.txt")
x2, y2 = read_series_from_file("m_s_test2.txt")
x3, y3 = read_series_from_file("m_s_test3.txt")
x4, y4 = read_series_from_file("m_s_i_test1.txt")
x5, y5 = read_series_from_file("m_s_i_test2.txt")
x6, y6 = read_series_from_file("m_s_i_test3.txt")
